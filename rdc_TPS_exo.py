...
#            print(i, triple[0].number,triple_number, previous_triple_number)
        ...
        if print_style == 2:
            ...
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'triple', triple[0].time, f'snap {i}', triple[0].relative_inclination, triple[0].dynamical_instability, triple[0].kozai_type, triple[0].error_flag_secular, triple[0].CPU_time, sep=', ')
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'inner binary', triple[0].child2.bin_type, triple[0].child2.is_mt_stable, triple[0].child2.semimajor_axis, triple[0].child2.eccentricity, triple[0].child2.argument_of_pericenter, triple[0].child2.longitude_of_ascending_node, sep=', ')
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'outer binary', triple[0].bin_type, triple[0].is_mt_stable, triple[0].semimajor_axis, triple[0].eccentricity, triple[0].argument_of_pericenter, triple[0].longitude_of_ascending_node, sep=', ')
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'primary star', triple[0].child2.child1.is_donor, triple[0].child2.child1.stellar_type, triple[0].child2.child1.mass,  triple[0].child2.child1.spin_angular_frequency, triple[0].child2.child1.radius, triple[0].child2.child1.core_mass, sep=', ')
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'secondary star', triple[0].child2.child2.is_donor,  triple[0].child2.child2.stellar_type, triple[0].child2.child2.mass, triple[0].child2.child2.spin_angular_frequency, triple[0].child2.child2.radius,triple[0].child2.child2.core_mass,  sep=', ')
            snapshot_string = snapshot_string + print_to_string(triple[0].number, 'CB planet', triple[0].child1.is_donor, triple[0].child1.stellar_type, triple[0].child1.mass, triple[0].child1.spin_angular_frequency, triple[0].child1.radius, triple[0].child1.core_mass, sep=', ')
